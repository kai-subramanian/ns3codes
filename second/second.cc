...
int main (int argc, char *argv[]){
        bool verbose = true;
        uint32_t nCsma = 3;
//usigned 32 bit integer; no of csma nodes is 3.
        CommandLine cmd;
        ...
        csmaNodes.Create (nCsma);       //ncsma = 3; declared already
        ...
        //stack.Install (p2pNodes.Get(1)) is not installed
...
//server is csmaNodes.Get(3); hence n4 is the server.
...
//pcap is opened using wireshark or tcptemp.
